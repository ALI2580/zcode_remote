...
本文件保留旧 Zemote 回归史，版本/文件路径/完成状态不代表当前 V2。当前开发先读 [V2 回归排查](regression-debugging.md) 与 [仓库最新 lessons](../../../../references/lessons.md)。新增经验维护在这两个当前入口；下面旧例用于追溯，涉及当前协议、重试、CI、包名与工具链时须复核源码。
