...
void main() {
  testWidgets(
      'review: whole assistant Markdown selection includes fenced code in reading order',
      (tester) async {
    ...
    expect(copied, contains('final preserveCode = 42;'));
    expect(copied, contains('return preserveCode;'));
    expect(copied, contains('After the code block.'));
    expect(copied!.indexOf('final preserveCode'),
        lessThan(copied!.indexOf('After the code block.')));
