...
void main() {
  const url =
      'https://zcode.z.ai/remote/v4?sid=abc123&hash=xyz&t=1700000000&mid=m1&name=Desktop';
  ...
  test('persists across reloads', () async {
    ...
    final reloaded = DeviceStore(requireEncryption: false);
    await reloaded.load();
